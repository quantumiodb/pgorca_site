...
date: 2026-05-28
tags: [postgres, orca, internals, optimizer]
...
Now that you know what's happening inside the optimizer, the natural
follow-up is what you can tune from the outside. See
[Configuring pg_orca: a guide to the GUCs you'll actually use](/blog/pg-orca-guc-reference)
for the master switch, cost-model selector, join-order algorithms,
and the debug prints that surface every step of the four-step pipeline
described above.
